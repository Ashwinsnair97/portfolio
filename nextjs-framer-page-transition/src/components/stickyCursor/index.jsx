...
export default function index({stickyElement, gifUrl}) {
  ...
  return (
    <div className={styles.cursorContainer}>
      <motion.div 
        ...
        animate={{
          width: gifUrl == ""?cursorSize: 160,
          height: gifUrl == ""? cursorSize: 100,
          backgroundColor: gifUrl == ""? "white": "transparent",
          mixBlendMode: gifUrl == ""? "difference": "initial", 
          rotate: gifUrl == ""? "": 0,
        }}
